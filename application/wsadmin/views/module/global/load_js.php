...
<?php echo assets_js('../js/moment.min.js'); ?>  
<?php echo assets_js('../js/bootstrap-datetimepicker.min.js'); ?>  
...
<script type="text/javascript">
	jQuery(function($) {
       ...
       jQuery("#formID").validationEngine({
        ...
        //barcode edit
        $("#formIDedit").submit(function(){
            idBarcode = $(".ws_barcode_title").val();
            window.location = "barcode/edit/"+idBarcode;    
            return false;
        });
